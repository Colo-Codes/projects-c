...
void drawBoard(int selection, int activePlayer);
int checkValid(int selection);
int checkWonDraw();
void updateBoard(int selection);
...
int main()
{
    ...
    while(wrongSelections < 4) // Allows 3 wrong guesses
    {
        ...
        drawBoard(selection, activePlayer);
