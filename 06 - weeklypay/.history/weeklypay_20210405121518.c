...
int main()
{
    ...
    {
        taxes = (TAXES_LOWER_LIMIT * TAXES_FIRST_STEP / 100) + ((weeklyPay - TAXES_LOWER_LIMIT) * TAXES_SECOND_STEP / 100);
    }
    else
    {
        taxes = (TAXES_LOWER_LIMIT * TAXES_FIRST_STEP / 100) + ((TAXES_MEDIUM_LIMIT - TAXES_LOWER_LIMIT) * TAXES_SECOND_STEP / 100) + ((weeklyPay - TAXES_MEDIUM_LIMIT) * TAXES_THIRD_STEP / 100);
    }
